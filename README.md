# Приложение для расчёта геометрической задачи для варианта №3

Приложение должно позволять по введённым координатам двух точек $(x_1, y_1)$ и $(x_2, y_2)$ и по радиусу окружности $R$
вычислять координаты центра окружности введённого радиуса, которая проходит через указанные точки. Приложение должно
выводить оба возможных варианта.
...
* Четыре поля для ввода координат $x_1$, $y_1$, $x_2$, $y_2$ и поле для ввода радиуса $R$. Поля обязательны для
  заполнения и должны содержать вещественные числа, при этом радиус должен быть положителен, а точки $(x_1, y_1)$ и
  $(x_2, y_2)$ не должны совпадать.
...
* координаты центра окружности для первого случая;
* координаты центра окружности для второго случая.
